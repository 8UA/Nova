...
default_engine = "https://duckduckgo.com/"
...
class MainWindow(QMainWindow):
	...
	def __init__(self, *args, **kwargs):
		...
		self.browser.setUrl(QUrl(default_engine))
		...
		# set this browser as central widget or main window (if exiting from maximized window)
